...
flags.DEFINE_string("data_dir", "/home/hyperdog/tensorflow_datasets", "Path to finetuning dataset, in RLDS format.")
flags.DEFINE_string("save_dir", "/home/hyperdog/octo/checkpoints", "Directory for saving finetuning checkpoints.")
...
def main(_):
    ...
    dataset = make_single_dataset(
        dataset_kwargs=dict(
            name="grasping_dataset:1.0.1",
            data_dir=FLAGS.data_dir,
            image_obs_keys = {"primary": "image_main", "wrist": "image_wrist"},
            depth_obs_keys={"primary": "image_depth"},
    ...
    ###
    config["model"]["observation_tokenizers"]["depth"] = ModuleSpec.create(
        ImageTokenizer,
        encoder = ModuleSpec.create(SmallStem16),
        obs_stack_keys = ['depth_primary'],
        task_stack_keys = ['depth_primary'],)
